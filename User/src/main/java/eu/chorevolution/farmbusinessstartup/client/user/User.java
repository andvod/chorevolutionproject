...
import eu.chorevolution.farmbusinessstartup.client.ChoreographyInstanceRequest;
...
public class User {
	...
	public static void main(String[] args) {
		...
		choreographyInstanceRequest.setChoreographyId(String.valueOf(System.nanoTime()));
		farmBusinessStartupRequestType.setChoreographyId(choreographyInstanceRequest);
		...
		LOGGER.info("******* USER *******");
		LOGGER.info("******* USER *******");
		FarmBusinessStartupResponse farmBusinessStartupResponse = userPT.farmBusinessCodeRequest(farmBusinessStartupRequestType);
